...
@Entity
public class DDLRecordSetVersion {
	@Id
	@Column(name = "recordSetVersionId", nullable = false)
	private Long id;
	...
	@Column(name = "DDMStructureVersionId")
	private Long dDMStructureVersionId;
	...
	public Long getDDMStructureVersionId() {
		return dDMStructureVersionId;
	}

	public void setDDMStructureVersionId(Long dDMStructureVersionId) {
		this.dDMStructureVersionId = dDMStructureVersionId;
	}
