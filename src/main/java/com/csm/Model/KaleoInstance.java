...
@Entity
public class KaleoInstance {
	@Id
	@Column(name = "kaleoInstanceId", nullable = false)
	private Long id;
	...
	@Column(name = "kaleoDefinitionName", length = 200)
	private String kaleoDefinitionName;

	@Column(name = "kaleoDefinitionVersion")
	private Integer kaleoDefinitionVersion;

	@Column(name = "rootKaleoInstanceTokenId")
	private Long rootKaleoInstanceTokenId;
