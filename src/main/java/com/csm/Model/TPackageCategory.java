...
@Entity
@Table(name = "t_package_category")
public class TPackageCategory {
	@Id
	@Column(name = "intPackageCategoryId", nullable = false)
	private Integer id;

	@Column(name = "vchCategoryName", length = 164)
	private String vchCategoryName;

	@Column(name = "vchCategoryAlias", length = 500)
	private String vchCategoryAlias;
	...
	public String getVchCategoryAlias() {
		return vchCategoryAlias;
	}

	public void setVchCategoryAlias(String vchCategoryAlias) {
		this.vchCategoryAlias = vchCategoryAlias;
	}
