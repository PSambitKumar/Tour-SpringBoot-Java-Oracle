...
public class FragmentCollection {
	@Id
	@Column(name = "fragmentCollectionId", nullable = false)
	private Long id;
	...
	@Column(name = "fragmentCollectionKey", length = 75)
	private String fragmentCollectionKey;
	...
	public void setFragmentCollectionKey(String fragmentCollectionKey) {
		this.fragmentCollectionKey = fragmentCollectionKey;
	}
