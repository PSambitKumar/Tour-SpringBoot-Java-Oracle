...
public class ChangesetEntry {
	@Id
	@Column(name = "changesetEntryId", nullable = false)
	private Long id;
	...
	@Column(name = "changesetCollectionId")
	private Long changesetCollectionId;
	...
	public void setChangesetCollectionId(Long changesetCollectionId) {
		this.changesetCollectionId = changesetCollectionId;
	}
