...
@Entity
public class SegmentsExperience {
	@Id
	@Column(name = "segmentsExperienceId", nullable = false)
	private Long id;
	...
	@Column(name = "segmentsExperienceKey", length = 75)
	private String segmentsExperienceKey;
	...
	public String getSegmentsExperienceKey() {
		return segmentsExperienceKey;
	}

	public void setSegmentsExperienceKey(String segmentsExperienceKey) {
		this.segmentsExperienceKey = segmentsExperienceKey;
	}
