...
@Entity
@Table(name = "t_hotel_details")
public class THotelDetail {
	@Id
	...
	@Column(name = "intApproveLabel")
	private Integer intApproveLabel;

	@Column(name = "vchRemarks", length = 256)
	private String vchRemarks;

	@Column(name = "intPropertyType")
	private Integer intPropertyType;

	@Column(name = "intOTDCRefNo")
	private Integer intOTDCRefNo;

	@Column(name = "vchDetailsUrl", length = 45)
	private String vchDetailsUrl;
	...
	public Integer getIntApproveLabel() {
		return intApproveLabel;
	}

	public void setIntApproveLabel(Integer intApproveLabel) {
		this.intApproveLabel = intApproveLabel;
	}
	...
	public Integer getIntPropertyType() {
		return intPropertyType;
	}

	public void setIntPropertyType(Integer intPropertyType) {
		this.intPropertyType = intPropertyType;
	}

	public Integer getIntOTDCRefNo() {
		return intOTDCRefNo;
	}

	public void setIntOTDCRefNo(Integer intOTDCRefNo) {
		this.intOTDCRefNo = intOTDCRefNo;
	}

	public String getVchDetailsUrl() {
		return vchDetailsUrl;
	}

	public void setVchDetailsUrl(String vchDetailsUrl) {
		this.vchDetailsUrl = vchDetailsUrl;
	}
