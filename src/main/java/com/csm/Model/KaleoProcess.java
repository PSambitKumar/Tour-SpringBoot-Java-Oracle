...
@Entity
public class KaleoProcess {
	@Id
	@Column(name = "kaleoProcessId", nullable = false)
	private Long id;
	...
	@Column(name = "DDLRecordSetId")
	private Long dDLRecordSetId;

	@Column(name = "DDMTemplateId")
	private Long dDMTemplateId;

	@Column(name = "workflowDefinitionName", length = 75)
	private String workflowDefinitionName;

	@Column(name = "workflowDefinitionVersion")
	...
	public void setDDLRecordSetId(Long dDLRecordSetId) {
		this.dDLRecordSetId = dDLRecordSetId;
	}
