...
public class QuartzSimpropTrigger {
	@EmbeddedId
	private QuartzSimpropTriggerId id;
	...
	private Byte boolProp1;

	@Column(name = "BOOL_PROP_2")
	private Byte boolProp2;

	public QuartzSimpropTriggerId getId() {
		return id;
	}

	public void setId(QuartzSimpropTriggerId id) {
		this.id = id;
	}
	...
	public Byte getBoolProp1() {
		return boolProp1;
	}

	public void setBoolProp1(Byte boolProp1) {
		this.boolProp1 = boolProp1;
	}

	public Byte getBoolProp2() {
		return boolProp2;
	}

	public void setBoolProp2(Byte boolProp2) {
