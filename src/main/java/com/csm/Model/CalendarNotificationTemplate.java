...
@Entity
public class CalendarNotificationTemplate {
	@Id
	@Column(name = "calendarNotificationTemplateId", nullable = false)
	private Long id;
	...
	@Column(name = "notificationType", length = 75)
	private String notificationType;

	@Column(name = "notificationTypeSettings", length = 75)
	private String notificationTypeSettings;

	@Column(name = "notificationTemplateType", length = 75)
	private String notificationTemplateType;

	@Column(name = "subject", length = 75)
